...
const ICON_FOR: Record<string, IconName> = {
  ...
  'file.export-html': 'cmd.export-html',
  'file.export-pdf': 'cmd.export-pdf',
  ...
  // Девять команд, один рисунок: номер стоит в подписи.
  'view.pane-1': 'cmd.pane',
  'view.pane-2': 'cmd.pane',
  'view.pane-3': 'cmd.pane',
  'view.pane-4': 'cmd.pane',
  'view.pane-5': 'cmd.pane',
  'view.pane-6': 'cmd.pane',
  'view.pane-7': 'cmd.pane',
  'view.pane-8': 'cmd.pane',
  'view.pane-9': 'cmd.pane',
  'view.move-tab-next-pane': 'cmd.move-tab-right',
  'view.move-tab-previous-pane': 'cmd.move-tab-left',
  'view.close-pane': 'cmd.close-pane',
  'file.reopen-tab': 'cmd.reopen-tab',
  'view.back': 'cmd.back',
  ...
  'notes.insert-template': 'cmd.template-insert',
  'notes.new-from-template': 'cmd.template-new',
