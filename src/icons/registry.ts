...
const ICONS: Record<IconName, string> = {
  ...
  'file.pdf':
    '<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linejoin="round"><path d="M9 1.6H4a1.4 1.4 0 0 0-1.4 1.4v10a1.4 1.4 0 0 0 1.4 1.4h8a1.4 1.4 0 0 0 1.4-1.4V6z"/><path d="M9 1.6V6h4.4"/><rect x="4.4" y="9" width="7.2" height="3.4" rx=".7" fill="currentColor" stroke="none"/></svg>',
  'file.image':
    '<svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linejoin="round"><path d="M9 1.6H4a1.4 1.4 0 0 0-1.4 1.4v10a1.4 1.4 0 0 0 1.4 1.4h8a1.4 1.4 0 0 0 1.4-1.4V6z"/><path d="M9 1.6V6h4.4"/><circle cx="6.1" cy="8.7" r=".85"/><path d="M4.4 12.5l2.3-2.1 1.4 1.2 1.3-1.4 2.2 2.3" stroke-linecap="round"/></svg>',
  'file.code':
  ...
  // Тот же лист, внутри — строки текста и стрелка вниз: лист, который
