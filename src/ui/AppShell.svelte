...
<div class="shell" class:drop={dropActive}>
  ...
  <div class="body">
    ...
    <!-- Рабочая область — дерево областей (Р-207): у каждой своя полоса
         вкладок и своё содержимое, что показывать — решает вид её активной
         вкладки. Вкладки ушли с уровня окна вместе с задачей 76: полоса
         во всю ширину принадлежала бы всем областям сразу, то есть никакой. -->
