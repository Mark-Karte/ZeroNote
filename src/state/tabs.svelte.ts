...
/**
 * Пути вкладок с несохранёнными правками.
 *
 * Спрашивают об этом все, кто собирается менять чужие файлы на диске:
 * переименование со ссылками (задача 48) и замена по проекту (задача 88).
 * Такие файлы не трогаются (Р-138) — запись под изменённым буфером всё равно
 * была бы затёрта первым же сохранением.
 */
