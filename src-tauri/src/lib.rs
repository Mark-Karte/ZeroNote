...
fn prepare_state() -> AppState {
    ...
    AppState {
        ...
        layout: std::sync::Mutex::new(model::layout::Layout::default()),
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::layout::layout_state,
            commands::layout::set_active_pane,
            commands::layout::set_active_tab,
            commands::layout::reorder_tab,
            commands::layout::remove_tab,
