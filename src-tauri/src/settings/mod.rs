...
//!
//! На этом этапе приложение файл только читает. Запись появится вместе с окном
//! параметров, и тогда же понадобится сохранять комментарии пользователя —
//! см. DESIGN.md, решение Р-013.
...
# Иначе — идентификатор темы: "light", "dark" или id вашей темы из data/themes/.
theme = "system"
