...
///
/// Это не «любая тёмная», а именно «One Dark» и «GitHub Light»: они берутся при
...
mod tests {
    ...
    /// в неожиданном месте: тёмно-синий «Tokyo Night» унаследовал бы серые
    /// границы «One Dark», и виновника пришлось бы искать глазами.
    #[test]
